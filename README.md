...
Data analysis project exploring the relationship between Bitcoin market sentiment (Fear &amp; Greed Index) and trader profitability, trading volume, and win rates using Hyperliquid historical trading data.
#**Tools Used**
  - Python
  - Pandas
  - Matplotlib
